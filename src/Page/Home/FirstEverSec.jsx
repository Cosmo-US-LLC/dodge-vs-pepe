...
import imgl from "../../assets/FirstEver/img (2).png";
import imgr from "../../assets/FirstEver/img (1).png";
function FirstEverSec() {
  return (
    <div className="w-[100%] bgeversec overflow-hidden w-[100%] pt-[60px] pb-[80px]">
      <div className="max-w-[1291.63px] space-y-[45px] w-[100%] mx-auto relative min-h-[500px]">
       ...
       <div className="relative">
            <img src={imgl} className="absolute -top-8 -left-10" alt="" />
